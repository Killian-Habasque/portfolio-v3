...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative h-full flex items-center rounded-full border border-transparent bg-[--color-dark] shadow-input flex justify-between space-x-16 px-2 py-2"
    >
      {children}
    </nav>
  );
