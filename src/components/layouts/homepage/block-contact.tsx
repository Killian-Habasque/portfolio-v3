    ...
    return (
        <section id="contact" className="py-20 flex items-center justify-center">
            <div className="px-4 lg:px-16 w-full flex items-center justify-center">
                ...
                >
                    <motion.h3
                        className="max-w-2xl text-5xl font-medium md:text-7xl text-white font-outfit z-10"
                        variants={{
                            ...textVariants,
                            visible: {
                    ...
                    >
                        N&apos;hésitez pas à me contacter pour échanger sur un projet ou une collaboration. <br />
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 w-full max-w-2xl z-10">
                        ...
                        <div className="flex flex-col lg:flex-row w-full justify-center gap-2 ">
                                ...
                                <Button variant="outline" className="w-full sm:w-auto" target="_blank" link="https://www.linkedin.com/in/killian-habasque-041841220/">
                                    <svg width="20px" height="15px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                            <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -7479.000000)" fill="black">
                            ...
                            <motion.div variants={{
                                ...
                                <Button className="w-full sm:w-auto" target="_blank" link="https://github.com/Killian-Habasque">
