...
export function HeroProject({
  ...
  return (
    ...
    >
      ...
      <div className='fixed lg:w-full lg:flex lg:justify-center mx-auto bottom-6 right-6 lg:right-0 lg:left-0 z-40'>
        <motion.div
          className='x-auto max-w-2xl flex gap-2 lg:gap-4'
          variants={{
            ...textVariants,
            visible: {
              ...textVariants.visible,
          ...
          {formattedProject.repoLink && (
            <Magnet padding={20} disabled={false} magnetStrength={7}>
              <a
                ...
                className="flex gap-2 px-4 lg:px-6 py-4 bg-secondary-dark text-white hover:bg-primary-dark hover:text-black h-full rounded-full flex gap-1 justify-center items-center font-outfit cursor-pointer fill-white hover:fill-black border border-white/[0.2]">
