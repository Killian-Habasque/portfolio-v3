      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          <div className="bg-black/50 flex items-center justify-center rounded-full backdrop-blur-md size-28 shadow-mg">
            ...
            >
              <PlayCircleIcon
                className="size-8 text-white fill-primary-light group-hover:scale-105 scale-100 transition-transform duration-200 ease-out"
                style={{
                  filter:
      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute top-4 right-4 z-10 text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-md rounded-full p-2 transition-opacity duration-200">
